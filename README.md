...
int main() {
    ...
    // Step 2: Jas inputs her private key
    printf("Enter Alice's private key: ");
    scanf("%lld", &privateKeyA);

    // Step 3: Compute Jas's public key (public_key = g^privateKeyA mod p)
    ...
    // Step 6: Jas decrypts the message (decryptedMessage = (c2 * c1^(p-1-privateKeyA)) mod p)
...
![image](https://github.com/user-attachments/assets/42fd4a3d-d5cd-42b4-84f4-8f00d125b359)
